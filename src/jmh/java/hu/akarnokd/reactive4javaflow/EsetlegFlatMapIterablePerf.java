...
@Fork(value = 1)
@State(Scope.Thread)
public class EsetlegFlatMapIterablePerf {
    ...
    Folyam<Integer> seqDirect;

    Folyam<Integer> seqArray;
    ...
    public void setup() {
        ...
        seq = Esetleg.just(1).flatMapIterable(v -> list);
        seqDirect = Folyam.fromIterable(list);
        seqArray = Folyam.fromArray(array);
    }
