...
public final class EsetlegFuture<T> extends Esetleg<T> implements FusedDynamicSource<T> {
    ...
    public EsetlegFuture(Future<? extends T> future, long timeout, TimeUnit unit) {
        this.future = future;
