...
public final class EsetlegErrorCallable<T> extends Esetleg<T> implements FusedDynamicSource<T> {

    final Callable<? extends Throwable> error;

    public EsetlegErrorCallable(Callable<? extends Throwable> error) {
        this.error = error;
    }
