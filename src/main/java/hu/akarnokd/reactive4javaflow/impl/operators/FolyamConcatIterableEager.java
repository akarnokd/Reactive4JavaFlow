...
public final class FolyamConcatIterableEager<T> extends Folyam<T> {
    ...
    public FolyamConcatIterableEager(Iterable<? extends Flow.Publisher<? extends T>> sources, int prefetch, boolean delayError) {
    ...
    protected void subscribeActual(FolyamSubscriber<? super T> s) {
        ...
        FolyamSubscriber<? super Flow.Publisher<? extends T>> subscriber =
                FolyamConcatMapEager.createSubscriber(s, v -> v, Integer.MAX_VALUE, prefetch, delayError);
