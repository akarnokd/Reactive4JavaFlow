 ...
 */
public final class ParallelMapOptionalTry<T, R> extends ParallelFolyam<R> {
    ...
    public ParallelMapOptionalTry(ParallelFolyam<T> source, CheckedFunction<? super T, ? extends Optional<? extends R>> mapper,
    ...
    public void subscribeActual(FolyamSubscriber<? super R>[] subscribers) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (a instanceof ConditionalSubscriber) {
                parents[i] = new ParallelMapOptionalTryConditionalSubscriber<T, R>((ConditionalSubscriber<? super R>)a, mapper, errorHandler);
            } else {
                parents[i] = new ParallelMapOptionalTrySubscriber<T, R>(a, mapper, errorHandler);
            }
        }
    ...
    static final class ParallelMapOptionalTrySubscriber<T, R> implements ConditionalSubscriber<T>, Flow.Subscription {
        ...
        ParallelMapOptionalTrySubscriber(FolyamSubscriber<? super R> actual, CheckedFunction<? super T, ? extends Optional<? extends R>> mapper,
                                         CheckedBiFunction<? super Long, ? super Throwable, ParallelFailureHandling> errorHandler) {
            this.actual = actual;
            this.mapper = mapper;
            this.errorHandler = errorHandler;
    ...
    static final class ParallelMapOptionalTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Flow.Subscription {
        ...
        ParallelMapOptionalTryConditionalSubscriber(ConditionalSubscriber<? super R> actual,
                                                    CheckedFunction<? super T, ? extends Optional<? extends R>> mapper,
                                                    CheckedBiFunction<? super Long, ? super Throwable, ParallelFailureHandling> errorHandler) {
            this.actual = actual;
            this.mapper = mapper;
            this.errorHandler = errorHandler;
