...
public final class EsetlegZipIterable<T, R> extends Esetleg<R> {
    ...
    public EsetlegZipIterable(Iterable<? extends Flow.Publisher<? extends T>> sources, CheckedFunction<? super Object[], ? extends R> zipper, boolean delayError) {
    ...
    protected void subscribeActual(FolyamSubscriber<? super R> s) {
        ...
        EsetlegZipArray.subscribe(srcs, n, s, zipper, delayError);
    }
}
