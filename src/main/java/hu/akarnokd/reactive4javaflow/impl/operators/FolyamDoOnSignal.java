...
public final class FolyamDoOnSignal<T> extends Folyam<T> {
    ...
    public static <T> Folyam<T> withOnSubscribe(Folyam<T> source, CheckedConsumer<? super Flow.Subscription> onSubscribe) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
            if (s.onSubscribe == null) {
                return new FolyamDoOnSignal<>(s.source,
                        onSubscribe,
                        s.onNext,
                        s.onAfterNext,
                        s.onError,
        ...
        return new FolyamDoOnSignal<>(source,
                onSubscribe,
                null,
                null,
                null,
    ...
    public static <T> Folyam<T> withOnNext(Folyam<T> source, CheckedConsumer<? super T> onNext) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
            if (s.onNext == null) {
                return new FolyamDoOnSignal<>(s.source,
    ...
    public static <T> Folyam<T> withOnAfterNext(Folyam<T> source, CheckedConsumer<? super T> onAfterNext) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
    ...
    public static <T> Folyam<T> withOnError(Folyam<T> source, CheckedConsumer<? super Throwable> onError) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
            if (s.onError == null) {
                return new FolyamDoOnSignal<>(s.source,
    ...
    public static <T> Folyam<T> withOnComplete(Folyam<T> source, CheckedRunnable onComplete) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
    ...
    public static <T> Folyam<T> withOnRequest(Folyam<T> source, CheckedConsumer<? super Long> onRequest) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
            if (s.onRequest == null) {
                return new FolyamDoOnSignal<>(s.source,
    ...
    public static <T> Folyam<T> withOnCancel(Folyam<T> source, CheckedRunnable onCancel) {
        if (source instanceof FolyamDoOnSignal) {
            FolyamDoOnSignal<T> s = (FolyamDoOnSignal<T>) source;
            if (s.onCancel == null) {
                return new FolyamDoOnSignal<>(s.source,
