...
public final class EsetlegAmbIterable<T> extends Esetleg<T> {

    final Iterable<? extends Esetleg<? extends T>> sources;

    public EsetlegAmbIterable(Iterable<? extends Esetleg<? extends T>> sources) {
