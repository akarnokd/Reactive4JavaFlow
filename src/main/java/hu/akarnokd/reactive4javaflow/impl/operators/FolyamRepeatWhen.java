...
public final class FolyamRepeatWhen<T> extends Folyam<T> {
    ...
    static abstract class AbstractRepeatWhen<T> extends SubscriptionArbiter implements FolyamSubscriber<T> {
        ...
        int wipEmission;
        static final VarHandle WIP_EMISSION = VH.find(MethodHandles.lookup(), AbstractRepeatWhen.class, "wipEmission", int.class);

        Throwable error;
        static final VarHandle ERROR = VH.find(MethodHandles.lookup(), AbstractRepeatWhen.class, "error", Throwable.class);

        int wipAgain;
        static final VarHandle WIP_AGAIN = VH.find(MethodHandles.lookup(), AbstractRepeatWhen.class, "wipAgain", int.class);
