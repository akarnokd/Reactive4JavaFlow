...
public final class FolyamMulticast<T, U, R> extends Folyam<R> {
    ...
    public FolyamMulticast(Folyam<T> source, CheckedFunction<? super Folyam<T>, ? extends ConnectableFolyam<U>> multicaster, CheckedFunction<? super Folyam<U>, ? extends Flow.Publisher<? extends R>> handler) {
        this.source = source;
