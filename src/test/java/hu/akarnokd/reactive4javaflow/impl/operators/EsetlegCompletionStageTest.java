...
public class EsetlegCompletionStageTest {

    @Test
    public void standard() {
        CompletableFuture<Integer> cf = CompletableFuture.completedFuture(1);
        TestHelper.assertResult(Esetleg.fromCompletionStage(cf), 1);
    }
    ...
    public void error() {
        ...
        Esetleg.fromCompletionStage(cf)
                .test()
    ...
    public void cancel() {
        ...
        TestConsumer<Integer> ts = Esetleg.fromCompletionStage(cf)
                .test()
                .cancel();
