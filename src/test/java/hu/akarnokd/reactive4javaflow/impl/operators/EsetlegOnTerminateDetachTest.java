...
public class EsetlegOnTerminateDetachTest {

    @Test
    public void standard() {
        TestHelper.assertResult(Esetleg.just(1).onTerminateDetach(), 1);
    }

    @Test
    public void standard2() {
        TestHelper.assertResult(
                Esetleg.just(1).hide().onTerminateDetach(),
                1);
    }
    ...
    public void verifyDetach1() throws Exception {
        ...
        TestConsumer<Object[]> tc = Esetleg.just(o)
                .onTerminateDetach()
                .test();
