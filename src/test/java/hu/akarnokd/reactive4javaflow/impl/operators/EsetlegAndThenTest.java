...
public class EsetlegAndThenTest {

    @Test
    public void standard() {
        TestHelper.assertResult(Esetleg.just(1).andThen(Esetleg.just(2)), 2);
    }

    @Test
    public void standard2() {
        TestHelper.assertResult(Esetleg.just(1).andThen(Folyam.range(2, 3)), 2, 3, 4);
    }
