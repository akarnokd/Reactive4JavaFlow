...
public class ParallelJoinAsyncTest {
    ...
    public void overflowFastpath() {
        TestHelper.withErrorTracking(errors -> {
            ...
            .sequential(SchedulerServices.trampoline(), 1)
            .test(0)
    ...
    public void emptyBackpressured() {
        Folyam.empty()
        .parallel()
        .sequential(SchedulerServices.trampoline())
        .test(0)
        .assertResult();
    }
    ...
    public void overflowFastpathDelayError() {
        ...
        .sequentialDelayError(SchedulerServices.trampoline(), 1)
        .test(0)
        .requestMore(1)
    ...
    public void emptyBackpressuredDelayError() {
        Folyam.empty()
        .parallel()
        .sequentialDelayError(SchedulerServices.trampoline())
        .test(0)
        .assertResult();
    }
