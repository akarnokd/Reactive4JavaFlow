...
@Test
public class CachingProcessorUnboundedAsPublisherTckTest extends BaseTck<Integer> {

    public CachingProcessorUnboundedAsPublisherTckTest() {
        super(100);
    }

    @Override
    public Flow.Publisher<Integer> createFlowPublisher(final long elements) {
        final CachingProcessor<Integer> pp = new CachingProcessor<>();
