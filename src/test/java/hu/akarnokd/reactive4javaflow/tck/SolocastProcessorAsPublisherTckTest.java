...
@Test
public class SolocastProcessorAsPublisherTckTest extends BaseTck<Integer> {

    public SolocastProcessorAsPublisherTckTest() {
        super(100);
    }

    @Override
    public Flow.Publisher<Integer> createFlowPublisher(final long elements) {
        final SolocastProcessor<Integer> pp = new SolocastProcessor<>();
