...
@Test
public class CachingProcessorTimeBoundAsPublisherTckTest extends BaseTck<Integer> {

    public CachingProcessorTimeBoundAsPublisherTckTest() {
        super(100);
    }

    @Override
    public Flow.Publisher<Integer> createFlowPublisher(final long elements) {
        final CachingProcessor<Integer> pp = new CachingProcessor<>(1, TimeUnit.MINUTES, SchedulerServices.computation());
